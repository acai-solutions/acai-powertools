...
from acai.boto3_helper.boto3_client import (
    Boto3ClientFactory,
    get_aws_client,
    get_boto3_resource,
)
from acai.boto3_helper.organizations import (
    OrganizationsHelper,
...
from acai.boto3_helper.s3 import S3ObjectManager
from acai.boto3_helper.sns import SnsClient, send_to_sns
from acai.boto3_helper.sts import StsClient
...
class TestStsClient(unittest.TestCase):
    def test_assume_role_success(self):
        ...
        with patch("acai.boto3_helper.sts.boto3.Session") as mock_boto_session:
...
class TestBoto3ClientFactory(unittest.TestCase):
    @patch("acai.boto3_helper.boto3_client.boto3.client")
    ...
    @patch("acai.boto3_helper.boto3_client.boto3.resource")
...
class TestOrganizationsHelperInitialization(unittest.TestCase):
    ...
    def test_initialization_without_client(self):
        ...
        with patch("acai.boto3_helper.organizations.boto3.client") as mock_boto:
            mock_client = MagicMock()
...
class TestOrganizationsHelperErrorHandling(unittest.TestCase):
    def test_get_organization_id_error(self):
        """Test get_organization_id handles errors gracefully."""
        mock_client = MagicMock()
        ...
        self.assertIsNone(helper.org_id)

    def test_get_tags_error(self):
        """Test get_tags handles errors gracefully."""
        mock_client = MagicMock()
        mock_client.describe_organization.return_value = {
            "Organization": {"Id": "o-123"}
        }
        ...
        helper = OrganizationsHelper(_Logger(), mock_client)
        tags = helper.get_tags("ou-123")

        self.assertEqual(tags, {})

    def test_describe_account_error(self):
        """Test describe_account handles errors gracefully."""
        mock_client = MagicMock()
        mock_client.describe_organization.return_value = {
            "Organization": {"Id": "o-123"}
        }
        ...
        helper = OrganizationsHelper(_Logger(), mock_client)
        result = helper._describe_account("invalid")
